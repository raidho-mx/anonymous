...
<div class="post_sharer">
	...
	<ul class="follow_links">
		<li class="follow_twitter"><a href="http://twitter.com/home?status=<?php echo wp_get_shortlink().': '; the_title(); ?> @_designaholic" target="_blank">Tw</a></li><li class="follow_google">
